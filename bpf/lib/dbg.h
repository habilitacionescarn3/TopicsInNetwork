...
/* Capture types */
#define DBG_CAPTURE_UNSPEC 0
#define DBG_CAPTURE_FROM_RESERVED1 1
#define DBG_CAPTURE_FROM_RESERVED2 2
#define DBG_CAPTURE_FROM_RESERVED3 3
#define DBG_CAPTURE_DELIVERY 4
#define DBG_CAPTURE_FROM_LB 5
#define DBG_CAPTURE_AFTER_V46 6
#define DBG_CAPTURE_AFTER_V64 7
#define DBG_CAPTURE_PROXY_PRE 8
#define DBG_CAPTURE_PROXY_POST 9
#define DBG_CAPTURE_SNAT_PRE 10
#define DBG_CAPTURE_SNAT_POST 11

#define DBG_CAPTURE_POLICY_VERDICT 12
#define DBG_CAPTURE_POLICY_MATCH 13
#define DBG_CAPTURE_POLICY_DENIED 14

/* Debugging for load balancer */
#define DBG_LB4_LOOKUP_FRONTEND     0
#define DBG_LB4_LOOKUP_FRONTEND_V2  1
#define DBG_LB4_LOOKUP_BACKEND      2
#define DBG_LB4_LOOKUP_BACKEND_V2   3
#define DBG_LB4_REVERSE_NAT_LOOKUP  4
#define DBG_LB4_REVERSE_NAT         5
#define DBG_LB4_LOOPBACK_SNAT       6
#define DBG_LB4_LOOPBACK_SNAT_REV   7
#define DBG_LB4_LOOKUP_MASTER_OIF   8
#define DBG_LB4_LOOKUP_MASTER_SVC   9
#define DBG_LB4_LOOKUP_SLAVE_OIF    10
#define DBG_LB4_LOOKUP_SLAVE        11
#define DBG_LB4_LOOKUP_SLAVE_V2     12
#define DBG_LB4_LOOKUP_BACKEND_SLOT 13
#define DBG_LB4_LOOKUP_BACKEND_SLOT_V2_FAIL 14
#define DBG_LB4_LEAST_CONN_DISABLED 15
#define DBG_LB4_LOOKUP_BACKEND_SLOT_SUCCESS 16
#define DBG_LB4_LEAST_CONN_SELECTED 17

#define DBG_LB6_LOOKUP_FRONTEND     0
#define DBG_LB6_LOOKUP_FRONTEND_V2  1
#define DBG_LB6_LOOKUP_BACKEND      2
#define DBG_LB6_LOOKUP_BACKEND_V2   3
#define DBG_LB6_REVERSE_NAT_LOOKUP  4
#define DBG_LB6_REVERSE_NAT         5
#define DBG_LB6_LOOKUP_BACKEND_SLOT 6
#define DBG_LB6_LOOKUP_BACKEND_SLOT_V2_FAIL 7
#define DBG_LB6_LEAST_CONN_DISABLED 8
#define DBG_LB6_LOOKUP_BACKEND_SLOT_SUCCESS 9
#define DBG_LB6_LEAST_CONN_SELECTED 10
